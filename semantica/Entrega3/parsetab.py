...
_lr_productions = [
  ...
  ('print_statement -> PRINT opening_par print_args closing_par semicol','print_statement',5,'p_print_statement','main.py',353),
  ('print_args -> print_args comma print_arg','print_args',3,'p_print_args','main.py',357),
  ('print_args -> print_arg','print_args',1,'p_print_args_single','main.py',361),
  ('print_arg -> expression','print_arg',1,'p_print_arg_expression','main.py',365),
  ('print_arg -> const_string','print_arg',1,'p_print_arg_string','main.py',370),
  ('print_statement -> PRINT opening_par error closing_par semicol','print_statement',5,'p_print_error','main.py',376),
  ('cycle -> DO start_cycle body WHILE opening_par expression closing_par end_cycle semicol','cycle',9,'p_cycle','main.py',383),
  ('start_cycle -> <empty>','start_cycle',0,'p_start_cycle','main.py',386),
  ('start_cycle_dummy -> <empty>','start_cycle_dummy',0,'p_start_cycle_dummy','main.py',389),
  ('end_cycle -> <empty>','end_cycle',0,'p_end_cycle','main.py',392),
  ('end_cycle_dummy -> <empty>','end_cycle_dummy',0,'p_end_cycle_dummy','main.py',395),
  ('cycle -> DO start_cycle_dummy body WHILE opening_par error closing_par end_cycle_dummy semicol','cycle',9,'p_cycle_error','main.py',399),
  ('condition -> IF opening_par expression closing_par gotof body check_else last_goto','condition',8,'p_condition','main.py',407),
  ('gotof -> <empty>','gotof',0,'p_gotof','main.py',410),
  ('gotof_dummy -> <empty>','gotof_dummy',0,'p_gotof_dummy','main.py',414),
  ('check_else -> else_goto body','check_else',2,'p_check_else','main.py',417),
  ('else_goto -> ELSE','else_goto',1,'p_else_goto','main.py',421),
  ('last_goto -> semicol','last_goto',1,'p_last_goto','main.py',425),
  ('last_goto_dummy -> semicol','last_goto_dummy',1,'p_last_goto_dummy','main.py',429),
  ('check_else -> <empty>','check_else',0,'p_check_else_empty','main.py',432),
  ('condition -> IF opening_par error gotof_dummy body check_else last_goto_dummy','condition',7,'p_condition_error','main.py',437),
]
