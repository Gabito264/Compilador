...
_lr_productions = [
  ...
  ('print_arg -> const_string','print_arg',1,'p_print_arg_string','main.py',369),
  ('print_statement -> PRINT opening_par error closing_par semicol','print_statement',5,'p_print_error','main.py',374),
  ('cycle -> DO body WHILE opening_par expression closing_par semicol','cycle',7,'p_cycle','main.py',381),
  ('cycle -> DO body WHILE opening_par error closing_par semicol','cycle',7,'p_cycle_error','main.py',386),
  ('condition -> IF opening_par expression closing_par gotof body check_else last_goto','condition',8,'p_condition','main.py',394),
  ('gotof -> <empty>','gotof',0,'p_gotof','main.py',397),
  ('gotof_dummy -> <empty>','gotof_dummy',0,'p_gotof_dummy','main.py',401),
  ('check_else -> else_goto body','check_else',2,'p_check_else','main.py',404),
  ('else_goto -> ELSE','else_goto',1,'p_else_goto','main.py',408),
  ('last_goto -> semicol','last_goto',1,'p_last_goto','main.py',412),
  ('last_goto_dummy -> semicol','last_goto_dummy',1,'p_last_goto_dummy','main.py',416),
  ('check_else -> <empty>','check_else',0,'p_check_else_empty','main.py',419),
  ('condition -> IF opening_par error gotof_dummy body check_else last_goto_dummy','condition',7,'p_condition_error','main.py',424),
]
